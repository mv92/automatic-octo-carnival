...
export const MOCK_ROUTES: SettingsRoute[] = [
	...
	{ uuid: '7', address: '10.0.1.1', mask: '16', gateway: '10.0.1.0', interface: 'Ethernet 0' },
	{ uuid: '8', address: '10.0.1.0', mask: '24', gateway: '10.0.1.254', interface: 'Ethernet 0' },
	{ uuid: '9', address: '169.254.0.1', mask: '16', gateway: '169.254.0.0', interface: 'Ethernet 1' },
	{ uuid: '10', address: '10.10.8.1', mask: '4', gateway: '10.10.8.0', interface: 'vpn0' },
	{ uuid: '11', address: '0.0.0.0', mask: '32', gateway: '10.0.0.1', interface: 'Ethernet 1' },
];

export const DEFAULT_MASK = 32;
